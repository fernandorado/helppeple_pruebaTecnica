...
import { fetchProductByCategory } from "../redux/reducers/categoriesReducer";
...
const CategoryProducts = () => {
  ...
  const products = useCustomSelector(
    (state) => state.cartegoriesReducer.categoryProducts
  );
  ...
  useEffect(() => {
    store.dispatch(fetchProductByCategory(Number(id)));
    // dispatch(fetchProductByCategory as any)(Number(id))
  }, [dispatch, id]);
